...
// location.search để lấy chuỗi URL bắt đầu từ ? , substring(1) để bỏ ? , split để bỏ hết các dấu & và trả về 1 mảng mới ( biễn chuỗi URL thành 1 mảng gồm nhiều phần tử)
...
var registerInfo = {
        ...
        birthDate: dataForm[6] + '/ ' + dataForm[5] + '/ ' + dataForm[4],
        sex: dataForm[7],
        passWord: dataForm[8],
}
